...
The values that give the best performance (**cross-validation accuracy of 99.5%**) are `C = 40.96` and `sigma=1/20`. These values are used to fit the final model, which will be the one used to make the predictions for the testing dataset.

**NOTE:** I am defining again the same subset of features but without `classe`, since the testing set does not have it.
